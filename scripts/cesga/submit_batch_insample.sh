...
#
# Uso:
#   sbatch submit_batch_insample.sh
#
# O con parámetros personalizados:
#   sbatch --export=GROUP=crypto_25,STRATEGY=donchian,PERMS=5000 submit_batch_insample.sh
#
# ============================================================================
...
# Ejecutar batch
python scripts/cesga/batch_insample.py \
    --group $GROUP \
    --strategy $STRATEGY \
