...
Examples:
    ...
    python utils/run_parallel_backtest.py --test-type insample

    # Run walk-forward with specific symbols
    python utils/run_parallel_backtest.py --test-type walkforward --symbols BTCUSD

    # Run with Dask backend
    python utils/run_parallel_backtest.py --backend dask --n-workers 12
"""
...
def run_insample_mcpt(
    ...
    """
    script_path = SCRIPTS_DIR / 'laptop' / 'insample_permutation.py'
...
def run_walkforward_mcpt(
    ...
    Returns:
        Return code from subprocess
    """
    script_path = SCRIPTS_DIR / 'laptop' / 'walkforward_permutation.py'
